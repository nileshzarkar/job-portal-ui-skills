...
```bash
mkdir -p "D:\AI\job-portal-ui-skills\.claude\skills\feature-guide"
```

2. Save the generated explanation as a Markdown file at:

```text
D:\AI\job-portal-ui-skills\.claude\skills\feature-guide\$ARGUMENTS.md
```

For example:

- `/feature-guide authentication` → `authentication.md`
- `/feature-guide saved-jobs` → `saved-jobs.md`
- `/feature-guide company-browsing` → `company-browsing.md`

3. Write the explanation using the following format:
